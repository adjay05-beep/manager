    ...
    return [
        ft.Container(
            ...
            content=ft.Column([
                ft.Container(
                    content=ft.Row([
                        ft.IconButton(ft.Icons.ARROW_BACK, on_click=lambda e: asyncio.create_task(navigate_to("home")), icon_color="black"),
                ...
                ft.Container(
                    ...
                    content=ft.Column([
                        ...
                        ft.ElevatedButton("홈으로 돌아가기", on_click=lambda _: asyncio.create_task(navigate_to("home")), height=40, bgcolor="#1565C0", color="white")
